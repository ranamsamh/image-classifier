#** *REFERENCES ** *  #
# - https://github.com/codestin/flower_classifier/tree/553236c0e7afe27f2ea538cfb2af0dcf787181d5
...
# Get all components:
parser.add_argument('--image_dir', type=str, default='flowers/test/58/image_02672',
                    help='directory with the test image')
...
def predict(image_dir, topk, gpu):  # took model out
...
top_ps, top_labels, top_flowers = predict(image_dir, topk, gpu)
